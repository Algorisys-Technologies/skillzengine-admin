...
module.exports = {
    ...
    updateTest: function (req, res, next) {
        var obj = req.body;
        var toChange = { _id: ObjectId(obj.id) }
        var newValues = { qIds: obj.qIds, testName: obj.testName, testTime: obj.testTime, isAutoCalc: obj.isAutoCalc, groupid: obj.groupid, category: obj.category, isShowResult: obj.isShowResult, isScreenShare: obj.isScreenShare, isVideoShare: obj.isVideoShare  }
