...
const appRoutes: Routes = [
    ...
    {
        path: 'landing', component: HeaderComponent, children: [
            { path: 'dashboard', component: DashboardComponent, outlet: 'sidemenu' },
            { path: 'admintotaltest', component: TotalTestsComponent, outlet: 'sidemenu' },
            { path: 'adminthisweek', component: CurrentWeekComponent, outlet: 'sidemenu' },
            { path: 'admintodaylist', component: TodayComponent, outlet: 'sidemenu' },
            { path: 'notifications', component: NotificationsComponent, outlet: 'sidemenu' },
            { path: 'user', component: UserComponent, outlet: 'sidemenu' },
            { path: 'instructions', component: InstructionsComponent, outlet: 'sidemenu' },
            { path: 'testwiseresults', component: TestwiseresultsComponent, outlet: 'sidemenu' },
            { path: 'assigntest', component: AssigntestComponent, outlet: 'sidemenu' },
            { path: 'createtest', component: CreatetestComponent, outlet: 'sidemenu' },
            { path: 'changepassword', component: ChangepasswordComponent, outlet: 'sidemenu' },
            { path: 'allresults', component: AllresultsComponent, outlet: 'sidemenu' },
            { path: 'testdetails/:testid/:userid', component: TestdetailsComponent, outlet: 'sidemenu' },
            { path: 'groupmastr', component: GroupmastrComponent, outlet: 'sidemenu' },
            { path: 'allquestions', component: AllquestionsComponent, outlet: 'sidemenu' },
            { path: 'userwiseresults/:testid', component: UserwiseresultsComponent, outlet: 'sidemenu' },
            { path: 'showtest', component: ShowtestComponent, outlet: 'sidemenu' },
            { path: 'edittest/:_id', component: EdittestComponent, outlet: 'sidemenu' },
            { path: 'createcategory', component: CreatecategoryComponent, outlet: 'sidemenu' },
            { path: 'testresults/:testid', component: TestresultsComponent, outlet: 'sidemenu' },
